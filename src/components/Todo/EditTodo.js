...
const EditTodo = ({ todo, listedTodoId }) => {
  ...
  const handleUpdate = (e) => {
    ...
    axios
      .post(
        `${baseUrl}/todos/update-todo`,
        { id: listedTodoId, todoId: todo._id, todoTitle, todoDescription },
        {
  ...
  return (
    <>
      {loading && <Spinner />}
      <button
        className=" h-8 w-8 text-green-600 hover:text-green-700 text-2xl rounded-md font-medium "
        type="button"
